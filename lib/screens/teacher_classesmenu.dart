...
class TeacherClassesMenu extends StatefulWidget {
  const TeacherClassesMenu({super.key});

  @override
  State<TeacherClassesMenu> createState() => _TeacherClassesMenuState();
}

class _TeacherClassesMenuState extends State<TeacherClassesMenu> {
  @override
