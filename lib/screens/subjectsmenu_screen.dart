...
class SubjectsMenu extends StatefulWidget {
  const SubjectsMenu({super.key});

  @override
  State<SubjectsMenu> createState() => _SubjectsMenuState();
}

class _SubjectsMenuState extends State<SubjectsMenu> {
  @override
  ...
  void navigateToSubjectPage(String subjectName, BuildContext context) {
    ...
    switch (subjectName) {
      case "English":
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => EnglishContent()));
        break;
      case "Urdu":
