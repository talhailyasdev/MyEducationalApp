      ...
      Padding(
        ...
        child: Container(
          ...
          child: GridView.builder(
            ...
            itemCount: teacherHomescreenIcons.length,
            itemBuilder: (context, index) {
              return GestureDetector(
                  onTap: () => onIconTap(
                      context, teacherHomescreenIcons[index]['name']!, index),
                  child: Container(
                    width: 100,
                    height: 150,
                    decoration: ShapeDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          teacherHomescreenIcons[index]['iconpath']!,
                          height: 110.0,
                        ),
                      ],
                    ),
    ...
    Future.delayed(Duration(milliseconds: 150), () {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) {
          switch (iconName) {
            case 'Upload Keybooks':
              return const TeacherClassesMenu(); // Replace with actual page
            case 'Upload Notes':
              return const TeacherClassesMenu(); // Replace with actual page
            case 'Upload MCQS':
              return const TeacherClassesMenu(); // Replace with actual page
            ...
            case 'Upload Courses':
              return const TeacherClassesMenu(); // Replace with actual page
            default:
              return const TeacherClassesMenu(); // Default case or error handler
          }
        }),
      ).then((_) {
