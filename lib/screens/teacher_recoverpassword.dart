...
class TeacherRecoverPassword extends StatefulWidget {
  const TeacherRecoverPassword({super.key});

  @override
  State<TeacherRecoverPassword> createState() => _TeacherRecoverPasswordState();
}

class _TeacherRecoverPasswordState extends State<TeacherRecoverPassword> {
  @override
